...
class CournotDuopoly():
    ...
    def plot_mc_changes_both_firms(self):
                # Initialize the parameters
        a = 40  # Total demand when price equals zero 
    ...
    def plot_cournot_mc_changes_firm1(self):
         # Initialize the parameters
        mc2 = 10  # Marginal cost for firm 2
        a = 40  # Total demand when price equals zero 

        # Create a range of marginal costs for firm 1
        mc1_values = np.linspace(5, 20, 100)

        # Calculate optimal quantities for each marginal cost
        q1_opt_values = []
        q2_opt_values = []
        for mc1 in mc1_values:
        ...
        ax.plot(mc1_values, q1_opt_values, label='Quantity for firm 1')
        ax.plot(mc1_values, q2_opt_values, label='Quantity for firm 2')
